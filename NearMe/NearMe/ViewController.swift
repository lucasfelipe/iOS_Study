...
class ViewController: UIViewController {
    ...
    private func presentPlacesSheet(places: [PlaceAnnotation]) {
        ...
        let placesTableView = PlacesTableViewController(userLocation: userLocation, places: places)
        placesTableView.modalPresentationStyle = .pageSheet
        
        if let sheet = placesTableView.sheetPresentationController {
            sheet.prefersGrabberVisible = true
            sheet.detents = [.medium(), .large()]
            present(placesTableView, animated: true)
        }
    }
